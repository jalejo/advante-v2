...
const Services = () => {
  ...
  const activeServiceObject = ServicesList.find(
    (serv) => serv.id === activeService
  );
  ...
  return (
    <section className="designServicesWrapper">
      ...
      <div className="containerFull">
          ...
          >
            {ServicesList.map((serv) => (
              <SwiperSlide key={serv.id}>
                <div
                  className={`design-services-item ${
                    activeService === serv.id ? "active" : ""
                  } `}
        ...
        <DesignServiceContent selectedService={activeServiceObject} />
      </div>
    </section>
  );
};
